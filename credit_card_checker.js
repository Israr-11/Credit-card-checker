...
function validateCred(arr) {
  //Intially value
    ...
    for (let i = arr.length - 1; i >= 0; i--) {  // i--=i-1 //Looping
      let num = arr[i];
      if (isEven) {   //Checking even
        num *= 2;    //num=num*2 
        if (num > 9) {   //If num greater than 9 
          num -= 9;   //subtract 9
        }
      }
      sum += num;
  ...
  function findInvalidCards(batch) {
    ...
    for (let i = 0; i < batch.length; i++) { //loop over batch array
...
const creditCardNumbers = [
    [6011111111111117, 6011000990139424, 6011000990139424, 6011111111111117, 371449635398431],
    [4556782452323123, 4556782452323123, 4556782452323123, 4556782452323123, 4556782452323123],
    [5428072896563099, 5428072896563099, 5428072896563099, 5428072896563099, 5428072896563099],
    [343112345678903, 341112345678903, 348112345678903, 342112345678903, 340112345678903]
  ];
